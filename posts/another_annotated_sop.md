...
I find another good way to bring in our personality while staying professional is to talk about our value, which is also related to some why’s. What kind of research keeps us excited? I’m excited about real-word users (in the problem space), but everyone is motivated differently. Maybe you are excited about system design? Cool! Or applying new ML models? Also cool! This part also ties back to the opening questions.
...
Transition to the 3rd and final project. Another advice I got (for almost everything grad application related) is **don’t tell, but show**. Earlier I said that I’m motivated by real-word issues, and here I showed that I followed through my words with actions. 
...
Tie back to the motivation and answer why grad school. 
...
It may seem odd to risk the flow of a research-focused SoP and make us question if it’s even relevant. But MIT EECS doesn’t require PS, and I wanted to show what I care about and where I come from. This section is also intended to help the SoP stay professional when I touched on my personal background in the last section. Again, fine line to walk. Lastly, this experience connects to my career pursuit in academia mentioned later. 
...
This section aims to convince the reader that I know the strengths of the program, our interests align, and I’m valuable. The first part outlines my overall research interests, while I gave specific examples about the program and PIs in the second part. 

I chose to put my research statement here, not anywhere else. Up to this point, I’ve been signaling pieces about my motivation and research interests using the opening questions, projects, and my why story. The reader now has enough context and is ready for a punch. 
